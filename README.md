...
This codebase can also be run directly in the browser at [https://ciadhla.github.io/prop_rep/]. Here, you can upload the csv file without needing python installed on your device. Everything runs locally and no data leaves your device.
